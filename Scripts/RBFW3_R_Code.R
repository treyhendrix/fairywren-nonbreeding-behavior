...
#' ---
#' 
#' This document contains the R code used to produce the analyses, figures, and supplemental material for the article published in *Emu - Austral Ornithology* titled "Behavioural differences between ornamented and unornamented male Red-backed Fairywrens (*Malurus melanocephalus*) in the nonbreeding season". The complete list of authors is: Trey C. Hendrix, Facundo Fernandez-Duque, Sarah Toner, Lauren G. Hitt, Robin G. Thady, Megan Massa, Samantha J. Hagler, Margaux Armfield, Nathalie Clarke, Phoebe Honscheid, Sarah Khalil, Carly E. Hawkins, Samantha M. Lantz, Joseph F. Welklin, John P. Swaddle, Michael S. Webster, and Jordan Karubian. The DOI for the journal article is: [10.1080/01584197.2023.2182224](http://dx.doi.org/10.1080/01584197.2023.2182224)
#' 
...
#' 
#' # Data
#' This manuscript uses two data sets: (1) one containing focal behavioural observations, which is a file named "RBFW3_Anon_Data_210720.csv" and (2) one containing opportunistic behavioural observations, which is a file named "RBFW3_Anon_Opportunistic_Data_230116.csv"
#' 
#' Both data sets have been uploaded to Figshare using the following DOI links: 
#' 
...
#' First, it is necessary to add binary variables to our data set for our behaviours of interest:
## ----Binary, include = TRUE----------------------------------------------------------------------------------------------------------------------------
