...
date: "Updated on 12 February 2023"
output: 
  html_document:
    toc: true
    toc_depth: 2
...
RBFW_sup %>% select(Sender, Receiver, Sender_sex, Receiver_sex, Sender_category, Receiver_category) # looks good
...
# Plumage figure theme
simple_theme <- theme(panel.grid.major = element_blank(), 
                      panel.grid.minor = element_blank(),
                      panel.background = element_blank(), 
                      axis.line = element_line(colour = "black"), 
...
```{r Saving figure S6}
ggsave(print0(output_file_path, "/Figure_S6.pdf"), figure_s6, height = 7, width = 7)
```
